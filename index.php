...
<head xml:lang="en">
    ...
    <meta name="Author" content="$Id: index.php,v 1.145 2019/02/16 08:43:20 michael Exp $" />
    <meta name="Copyright" content="Copyright 2005-2019, IRCD-Hybrid Team" />
...
<div class="container" xml:lang="en">
    ...
    <div class="content" xml:lang="en">
        ...
        <p xml:lang="en"><br />
	    &raquo; <a href="downloads.html">Latest STABLE release of ircd-hybrid:&nbsp; 8.2.24</a> <br />
<!--            &raquo; <a href="downloads.html">Latest BETA release of ircd-hybrid:&nbsp; 8.2.0rc2</a> <br />    -->
	    &raquo; <a href="<?php echo $fname; ?>">Latest commit to TRUNK &mdash; <?php if ($delta >= 0) echo "$delta ago"; else echo "unknown"; ?></a><br /> <br />
            &raquo; <a href="downloads.html">Latest STABLE release of HOPM (hybrid open proxy monitor):&nbsp; 1.1.5</a> <br />
<!--            &raquo; <a href="downloads.html">Latest BETA release of HOPM (hybrid open proxy monitor):&nbsp; 1.1.0beta1</a> <br /> -->
    ...
    <div class="footer" xml:lang="en">
        <div class="right" xml:lang="en">
            <p xml:lang="en">Copyright &copy; 1997-2019 IRCD-Hybrid Development Team</p>
        ...
        <p xml:lang="en">$Id: index.php,v 1.145 2019/02/16 08:43:20 michael Exp $</p>
   </div>
</div>
