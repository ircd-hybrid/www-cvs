...
<head xml:lang="en">
    ...
    <meta name="Author" content="$Id: index.php,v 1.116 2015/06/06 20:01:53 michael Exp $" />
...
<!--            &raquo; <a href="downloads.html">Latest BETA release of ircd-hybrid:&nbsp; 8.2.0rc2</a> <br />    -->
	    &raquo; <a href="<?php echo $fname; ?>">Latest commit to TRUNK &mdash; <?php if ($delta >= 0) echo "$delta ago"; else echo "unknown"; ?></a><br /> <br />
            &raquo; <a href="downloads.html">Latest STABLE release of HOPM (hybrid open proxy monitor):&nbsp; 1.0.7</a> <br />
	</p>
    ...
    <div class="footer" xml:lang="en">
        ...
        <p xml:lang="en">$Id: index.php,v 1.116 2015/06/06 20:01:53 michael Exp $</p>
   </div>
</div>
